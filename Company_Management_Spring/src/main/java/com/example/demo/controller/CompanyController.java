...
public class CompanyController {
	...
	@GetMapping(path = "/formCompany") // Map ONLY GET Requests
	public String showCompanyForm(@ModelAttribute("company") company companyForm) {
		System.out.println("Inside formCompany Get endpoint");
//		model.addAttribute("companyForm", new company());
		return "formCompany";
	}

	@PostMapping(path = "/saveCompany") // Map ONLY POST Requests
	public String addNewCompany(@Valid @ModelAttribute("company") company companyForm, BindingResult bindingResult, Model model) {
